...
void divide_file1 (deque<Student>& stud,deque<Student>& kietiakai,deque<Student>& nuskriaustukai, string filename);

void divide_file2 (deque<Student>& stud,deque<Student>& nuskriaustukai, string filename);

void divide_file3 (deque<Student>& stud,deque<Student>& nuskriaustukai, string filename);

void pagrindinis_divide (deque<Student>& stud,deque<Student>& kietiakai,deque<Student>& nuskriaustukai, int num);
