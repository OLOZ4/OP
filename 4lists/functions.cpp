...
void divide_file1 (list<Student>& stud,list<Student>& kietiakai,list<Student>& nuskriaustukai, string filename) {
    string name = "studentai" + std::to_string(stud.size()) + ".txt";
    auto start = std::chrono::high_resolution_clock::now(); // Paleisti
    //nuskriaustukai.reserve(stud.size());
    //kietiakai.reserve(stud.size());
...
void divide_file2 (list<Student>& stud,list<Student>& nuskriaustukai, string filename) {
    string name = "studentai" + std::to_string(stud.size()) + ".txt";
    auto start = std::chrono::high_resolution_clock::now(); // Paleisti
    //nuskriaustukai.reserve(stud.size());
...
void divide_file3(list<Student>& stud, list<Student>& nuskriaustukai, string filename) {
    auto start = std::chrono::high_resolution_clock::now();
    ...
    // Move the failing students to nuskriaustukai
    nuskriaustukai = list<Student>(std::make_move_iterator(partition_point), std::make_move_iterator(stud.end()));
...
void pagrindinis_divide (list<Student> &stud, list<Student> &kietiakai, list<Student> &nuskriaustukai, int num) {
